...
-- -----------------------------------------------------
-- Table `DB_Control_Escolar`.`Grupo`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_Control_Escolar`.`Grupo` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Grupo` (
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Alumno` (
  ...
  CONSTRAINT `fk_Alumno_Grupo1`
    ...
    REFERENCES `DB_Control_Escolar`.`Grupo` (`Id_Grupo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
SHOW WARNINGS;
CREATE INDEX `fk_Alumno_Grupo1_idx` ON `DB_Control_Escolar`.`Alumno` (`Id_Grupo` ASC);
...
SHOW WARNINGS;
CREATE INDEX `fk_Clase_Grupo1_idx` ON `DB_Control_Escolar`.`Clase` (`Id_Grupo` ASC);
...
-- -----------------------------------------------------
-- Table `DB_Control_Escolar`.`Tipo_Asistencia`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_Control_Escolar`.`Tipo_Asistencia` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Tipo_Asistencia` (
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Asistencia` (
  ...
  CONSTRAINT `fk_Asistencia_Tipo_Asistenciaa1`
    ...
    REFERENCES `DB_Control_Escolar`.`Tipo_Asistencia` (`Id_Tipo_Asistencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `DB_Control_Escolar`.`Tipo_Evento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_Control_Escolar`.`Tipo_Evento` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Tipo_Evento` (
...
-- -----------------------------------------------------
-- Table `DB_Control_Escolar`.`Evento`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `DB_Control_Escolar`.`Evento` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Evento` (
  ...
  CONSTRAINT `fk_Evento_Tipo_Evento1`
    ...
    REFERENCES `DB_Control_Escolar`.`Tipo_Evento` (`Id_Tipo_Evento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

SHOW WARNINGS;
CREATE INDEX `fk_Evento_Clase1_idx` ON `DB_Control_Escolar`.`Evento` (`Id_Clase` ASC);

SHOW WARNINGS;
CREATE INDEX `fk_Evento_Tipo_Evento1_idx` ON `DB_Control_Escolar`.`Evento` (`Id_Tipo_Evento` ASC);
