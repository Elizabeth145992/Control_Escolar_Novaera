...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Usuario` (
  ...
  INDEX `fk_Usuario_Direccion_idx` (`Id_Direccion` ASC),
  INDEX `fk_Usuario_Rol1_idx` (`Id_Rol` ASC),
  INDEX `fk_Usuario_Genero1_idx` (`Id_Genero` ASC),
  INDEX `fk_Usuario_Estatus1_idx` (`Id_Estatus` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Personal_Escolar` (
  ...
  INDEX `fk_Docente_Usuario1_idx` (`Id_Usuario` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Alumno` (
  ...
  INDEX `fk_Alumno_Nivel1_idx` (`Id_Nivel` ASC),
  INDEX `fk_Alumno_Grado1_idx` (`Id_Grado` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Clase` (
  ...
  INDEX `fk_Clase_Nivel1_idx` (`Id_Nivel` ASC),
  INDEX `fk_Clase_Grado1_idx` (`Id_Grado` ASC),
  INDEX `fk_Clase_Personal_Escolar1_idx` (`Id_Personal_Escolar` ASC),
  INDEX `fk_Clase_Estatus1_idx` (`Id_Estatus` ASC),
  INDEX `fk_Clase_Periodo1_idx` (`Id_Periodo` ASC),
  INDEX `fk_Clase_Horario_Clase1_idx` (`Id_Horario_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Alumno_Clase` (
  ...
  INDEX `fk_Alumno_Clase_Alumno1_idx` (`Id_Alumno` ASC),
  INDEX `fk_Alumno_Clase_Clase1_idx` (`Id_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Actividad` (
  ...
  INDEX `fk_Actividad_Personal_Escolar1_idx` (`Id_Personal_Escolar` ASC),
  INDEX `fk_Actividad_Clase1_idx` (`Id_Clase` ASC),
  INDEX `fk_Actividad_Recurso1_idx` (`Id_Recurso` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Biblioteca_Virtual` (
  ...
  INDEX `fk_Biblioteca_Virtual_Estatus1_idx` (`Id_Estatus` ASC),
  INDEX `fk_Biblioteca_Virtual_Recurso1_idx` (`Id_Recurso` ASC),
  INDEX `fk_Biblioteca_Virtual_Clase1_idx` (`Id_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Padre_Alumno` (
  ...
  INDEX `fk_Padre_Alumno_Alumno1_idx` (`Id_Alumno` ASC),
  INDEX `fk_Padre_Alumno_Usuario1_idx` (`Id_Padre` ASC),
  INDEX `fk_Padre_Alumno_Pago1_idx` (`Id_Pago` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Calificacion_Parcial` (
  ...
  INDEX `fk_Calificacion_Parcial_Alumno1_idx` (`Id_Alumno` ASC),
  INDEX `fk_Calificacion_Parcial_Alumno_Clase1_idx` (`Id_Alumno_Clase` ASC),
  INDEX `fk_Calificacion_Parcial_Parcial1_idx` (`Id_Parcial` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Calificacion_Final` (
  ...
  INDEX `fk_Calificacion_Final_Alumno1_idx` (`Id_Alumno` ASC),
  INDEX `fk_Calificacion_Final_Alumno_Clase1_idx` (`Id_Alumno_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Asistencia` (
  ...
  `Id_Personal_Escolar` INT NOT NULL,
  `Id_Alumno_Clase` INT NOT NULL,
  PRIMARY KEY (`Id_Asistencia`, `Id_Alumno`, `Id_Personal_Escolar`, `Id_Alumno_Clase`),
  INDEX `fk_Asistencia_Alumno1_idx` (`Id_Alumno` ASC),
  INDEX `fk_Asistencia_Personal_Escolar1_idx` (`Id_Personal_Escolar` ASC),
  INDEX `fk_Asistencia_Alumno_Clase1_idx` (`Id_Alumno_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Evaluacion` (
  ...
  INDEX `fk_Evaluacion_Recurso1_idx` (`Id_Recurso` ASC),
  INDEX `fk_Evaluacion_Clase1_idx` (`Id_Clase` ASC),
...
CREATE TABLE IF NOT EXISTS `DB_Control_Escolar`.`Revision` (
  ...
  INDEX `fk_Revision_Evaluacion1_idx` (`Id_Evaluación` ASC),
  INDEX `fk_Revision_Alumno_Clase1_idx` (`Id_Alumno_Clase` ASC),
