    ...
    var table2 = $('#dataTableAlumnosP').DataTable({
     ...
     var table3 = $('#dataTableAlumnosE').DataTable({
        ...
        'columns': [
           ...
           { data: 'Grado' },
           { data: 'Grupo' },
           { defaultContent: '<button type="button" class="editar2 btn btn-warning"><i class="fas fa-pencil-alt"></i></button>' }
        ],
        "language": {
            "url": "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Spanish.json"
        }});
        ...
        var table4 = $('#dataTableAlumnosS').DataTable({
            ...
            var table5 = $('#dataTableAlumnosP3').DataTable({
                ...
                'columns': [
                   ...
                   { data: 'Grado' },
                   { data: 'Grupo' },
                   { defaultContent: '<button type="button" class="editar4 btn btn-warning"><i class="fas fa-pencil-alt"></i></button>' }
                ],
                "language": {
                    "url": "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Spanish.json"
                }});
     ...
     obtener_data_editar4("", table5);
     obtener_data_editar2("", table3);
    });
