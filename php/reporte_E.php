...
$pdf->setY(30);
$pdf->Cell(0,0,utf8_decode('Calificaciones de las Evaluaciones de:'.$nombreM),0,1,'C');
$pdf->setY(37);
...
$header=array('Apellido Paterno','Apellido Materno','Nombre', utf8_decode('# de Evaluación'),utf8_decode('Calificación Final'));
$pdf->AliasNbPages();
//$pdf->AddPage();
