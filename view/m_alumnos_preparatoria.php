...
session_start();
include("header.php");
echo '<script src="../js/m_usuarioPre.js"></script>';
...
<div class="modal" id="alumno4" tabindex="-1" ole="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body" id="alumno5">
