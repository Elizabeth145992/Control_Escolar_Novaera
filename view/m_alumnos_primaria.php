...
session_start();
include("header.php");
echo '<script src="../js/m_usuarioPr.js"></script>';
include("principal.html");
?>
<h5 class="clases">Alumnos de Primaria</h5>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Listado de alumnos del nivel Primaria</h6>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTableAlumnosE" width="100%" cellspacing="0">
        <thead id="tabla">
          <tr>
...
<div class="modal" id="alumno3" tabindex="-1" ole="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body" id="alumno4">
