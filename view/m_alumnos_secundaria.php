...
?>
<h5 class="clases">Alumnos de Secundaria</h5>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Listado de alumnos del nivel Secundaria</h6>
  </div>
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered" id="dataTableAlumnosS" width="100%" cellspacing="0">
        <thead id="tabla">
          <tr>
