...
session_start();
include("header.php");
echo '<script src="../js/m_usuarios_personalC.js"></script>';
include("principal.html");
?>
<h5 class="clases">Personal Escolar</h5>
...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Listado del personal escolar</h6>
  </div>
  <div class="card-body">
 ...
 <div class="modal" id="personal1" tabindex="-1" ole="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body" id="personal2">
                    <p><h3>Edición de Personal Escolar</h3></p><br>
...
<div class="col">
    ...
    <input type="text" class="form-control input_tamano" id="puesto" name="puesto" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]+" minlength="6" maxlength="100" required>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body" id="alumnoestatus2">
                    <p><h3>Edición del estatus del personal escolar</h3></p><br>
