...
?>
  ...
  <div class="col">
    <div id="card_alumno" class="card borde sombra tamano">
      <img class="img-fluid" src="../img/artes.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card borde sombra">
      <img class="img-fluid" src="../img/ingles.jpg" class="card-img-top" alt="...">
      <div class="card-body">
...
<div id="card_padres" class="card borde sombra centro">
  <h5 class="card-header">Daniela Gacía Ruiz</h5>
  <div class="card-body">
