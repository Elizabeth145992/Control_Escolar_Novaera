...
session_start();
include("header.php");
echo '<script src="../js/m_calif_p.js"></script>';
include("principal.html");
?>
<h5 class="clases">Reporte de Calificaciones Parciales</h5>
...
<div id="tabla2">
<h2 class="centro">Visualiza aquí todas las calificaciones parciales de tus alumnos</h2>
<div id=p></div>
